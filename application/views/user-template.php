...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo base_url('user/wallet/recharge') ?>">
		...
		<li class="nav-item">
            <a class="nav-link "  href="<?php echo base_url('user\account\new') ?>">
                <i class="bi bi-journal-text"></i><span>Inscription</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        </li>
		<li class="nav-item">
            <a class="nav-link "  href="<?php echo base_url('login\user') ?>">
                <i class="bi bi-journal-text"></i><span>Connexion</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?php echo base_url('place/liste') ?>" class="active">
                        <i class="bi bi-circle"></i><span>Disponibilité</span>
                    </a>
                </li>
            </ul>
        </li>
		<li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
				<li>
                    <a href="<?php echo base_url('user/wallet/view') ?>" class="active">
                        <i class="bi bi-circle"></i><span>Argent</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url('user/wallet/recharge') ?>" class="active">
                        <i class="bi bi-circle"></i><span>Recharger</span>
                    </a>
                </li>
            </ul>
        </li>
